...
outfile                 =   fullfile(resultspath, ['kalman_oos_k_varFactors_startY_',num2str(start),...
...
for ye                  =   1:length(startYears),
	...
	for mon                 =   1:12,
        ...
        %   EM-PCA
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        [f{ye,mon}, B{ye,mon}, kList{ye,mon}, tstat{ye,mon}, ICp{ye,mon},...
            retData{ye,mon}, pList{ye,mon}, lab{ye,mon}] ...
                            =   em_pca_ic_it(win ,year, mon, retM);
        k                   =   kList{ye,mon}
